 ...
 ;(function($){
	...
	$.jSlots = function(el,options){
		...
		base.setup = function(){
			...
			base.increment = (base.options.time / base.options.loops) / base.options.loops;  console.log("Time divided by Loops "+(base.options.time/base.options.loops)+"/ Loops: "+base.options.loops);
		...
		base.bindEvents = function(){
			$(base.options.spinner).bind(base.options.spinEvent, function(e){
				if(!base.isSpinning){
					base.playSlots();
				}
			});
